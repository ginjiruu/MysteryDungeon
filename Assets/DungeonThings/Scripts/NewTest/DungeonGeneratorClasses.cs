...
public class Dungeon {	
	...
	public	Dungeon( DungeonTile[,] tiles,	int[,] regions){
		this.tiles		= tiles;
		this.regions	= regions;
	}
	
	public	Dungeon( DungeonTile[,] tiles,	int[,] regions, IntVector2 entrance, IntVector2 exit){
		this.tiles		= tiles;
		this.regions	= regions;
...
public	enum DungeonTile{None, Hole, Floor, RoomFloor, Wall, Door, OpenDoor, ClosedDoor, DoorNorth, DoorEast, DoorSouth, DoorWest, Spawner};
...
public class RoomDungeon:Dungeon {
	...
	public	void MirrorTileArray( DungeonTile[,] array, bool horizontal){
		
		int xSize = array.GetLength(0);
		int ySize = array.GetLength(1);
		
		DungeonTile[,] newArray = new DungeonTile[xSize,ySize];
...
//template of a room
	public class RoomTemplate/*, System.IComparable<RoomTemplate>*/{
		...
		public DungeonTile[,] tiles;	//Tilegrid of the room
		...
		public RoomTemplate(DungeonTile[,] tiles, List<Door> potentialDoors){			
			this.tiles	= tiles;
	...
	public class Room : RoomTemplate{
		...
		public Room(DungeonTile[,] tiles, int x, int y, List<Door> potentialDoors){			
			this.tiles	= tiles;	
			this.x		= x;			
			this.y		= y;
			this.potentialDoors = potentialDoors;
